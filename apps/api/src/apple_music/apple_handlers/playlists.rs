...
use crate::services::playlist_builder::{
    ...
    contributing_artist_events, find_artist_events_near, genres_to_priorities,
...
pub async fn create_playlist(
    ...
    let song_ids: Vec<String> = search_result.tracks.iter().map(|t| t.uri.clone()).collect();
    ...
    // nearby event's performer (sports teams/events never match anything
